                            ...
                            <div class="card redial-border-light redial-shadow">
                                <div class="card-body">
                                    <h6 class="header-title pr-3 redial-relative">
                                        <?= (@$_GET['type'] == JOMOAA ? 'خطب الجمعة' : (@$_GET['type'] == TAFSSIR ? 'تفسير الاحلام' : 'الرقية الشرعية')) ?>
                                    </h6>
                                    <table class="table table-striped table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= URLROOT . 'pages/articles/edit&article_id=' . $article->id ?>"
                                                        type="button" class="btn btn-primary">تعديل</a>
                                                    <button type="button" class="btn btn-danger" data-toggle="modal"
                                                        data-target="#model<?= $article->id ?>">حذف</button>
                                                </td>

                                            </tr>
                                            <div class="modal fade" id="model<?= $article->id ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog  modal-md" role="document">
                                                    <div class="modal-content redial-border-light">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>هل تريد حذف: <?= '<b>' . $article->title . '</b>' ?>
                                                            </p>
                                                        </div>
                                                        <div class="modal-footer redial-border-light">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">الغاء</button>
                                                            <a href="<?= URLROOT . 'pages/articles/del&article_id=' . $article->id ?>"
