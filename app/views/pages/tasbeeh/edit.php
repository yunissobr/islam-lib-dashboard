                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="card redial-border-light redial-shadow mb-4">
                                <div class="card-body">
                                    <h6 class="header-title pr-3 redial-relative">اضف تسبيح جديد</h6>
                                    <form method="POST">
                                        <div class="form-group">
                                            <label class="redial-font-weight-600">تسبيح</label>
                                            <input type="text" required class="form-control" name="tasbeeh"
                                                placeholder="تسبيح" value="<?= $data['current_tasbeeh']->tasbeeh ?>" />
                                            <input type="number" required style="display: none;" name="tasbeeh_id"
                                                value="<?= $data['current_tasbeeh']->id ?>" />
                                        </div>

                                        <div class="redial-divider my-4"></div>
                                        <button type="submit" class="btn btn-primary btn-xs"
                                            name="edit_tasbeeh">حفظ</button>
                                    </form>
                                </div>
                            </div>
                        </div>
