                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="card redial-border-light redial-shadow mb-4">
                                <div class="card-body">
                                    <h6 class="header-title pr-3 redial-relative">تعديل الاذكار</h6>
                                    <form method="post">
                                        <div class="form-group" style="display: none;">
                                            <input type="number" required name="dhiker_id"
                                                value="<?= $data['current_dhiker']->id ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label class="redial-font-weight-600">الذكر</label>
                                            <input type="text" required class="form-control" name="dhiker"
                                                placeholder="الذكر" value="<?= $data['current_dhiker']->dhiker ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label class="redial-font-weight-600">عدد التكرار</label>
                                            <input type="number" required class="form-control" name="repetitions"
                                                value="<?= $data['current_dhiker']->repetitions ?>"
                                                placeholder="عدد التكرار" />
                                        </div>
                                        <div class="form-group">
                                            <label class="redial-font-weight-600">نوع الأذكار</label>
                                            <select class="form-control" name="type">
                                                <option value=<?= MORNING_AZKAR ?>
                                                    <?= ($data['current_dhiker']->type == MORNING_AZKAR) ? 'selected' : '' ?>>
                                                    اذكار الصباح</option>
                                                <option value=<?= AFTERNON_AZKAR ?>
                                                    <?= ($data['current_dhiker']->type == AFTERNON_AZKAR) ? 'selected' : '' ?>>
                                                    اذكار المساء</option>
                                            </select>
                                        </div>
